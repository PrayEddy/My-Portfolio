...
```sh
  cd my-folder
  git clone https://github.com/PrayEddy/My-Portfolio.git
```
...
- GitHub: [EddyShimwa](https://github.com/PrayEddy)
...
Feel free to check the [issues page](https://github.com/PrayEddy/My-Portfolio/issues).
